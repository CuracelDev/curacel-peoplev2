...
export default function EditInterestFormPage() {
  ...
  const updateFormMutation = trpc.interestForm.update.useMutation({
    onSuccess: () => {
      ...
      router.push('/recruiting/settings/interest-forms')
    },
    onError: (error) => {
    ...
    return (
      <div className="text-center py-10">
        ...
        <Button variant="outline" className="mt-4" asChild>
          <Link href="/recruiting/settings/interest-forms">Back to Interest Forms</Link>
        </Button>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/recruiting/settings/interest-forms">
        ...
        <Button variant="outline" asChild>
          <Link href="/recruiting/settings/interest-forms">Cancel</Link>
        </Button>
        <Button
          onClick={handleSave}
