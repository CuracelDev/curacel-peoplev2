...
export default function RecruitingDashboard() {
  ...
  return (
    <div className="p-6">
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Welcome back, Henry</h1>
        <p className="text-sm text-gray-500">Here&apos;s what&apos;s happening with your hiring pipeline</p>
      </div>
