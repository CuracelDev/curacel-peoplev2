...
import { ArrowLeft, Eye, Loader2, MousePointer2, Settings } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/settings/email-settings">
        ...
        <div>
          ...
          <p className="text-sm text-foreground/80">
            Configure email sending and tracking for candidate communications.
          </p>
        </div>
      </div>
